...
CREATE TABLE IF NOT EXISTS alternative_identifiers (
    uuid TEXT NOT NULL, --cannot be primary key as there is duplicates
...
CREATE TABLE IF NOT EXISTS constituents (
    ...
    -- uuid TEXT, this column does not exist in the actual CSV file for constituents
    ULANID TEXT,
...
CREATE TABLE IF NOT EXISTS objects (
    ...
    -- uuid TEXT, not in CSV
    accessioned INTEGER NOT NULL,
    accessionNum TEXT,
    -- objectLeonardoID TEXT, not in CSV
    locationID INTEGER,
    title TEXT,
    displayDate TEXT,
    beginYear INTEGER,
...
CREATE TABLE IF NOT EXISTS preferred_locations (
    locationKey TEXT NOT NULL, -- PRIMARY KEY, cannot be primary key as there are duplicates
...
CREATE TABLE IF NOT EXISTS preferred_locations_tms_locations (
    ...
    -- FOREIGN KEY (preferredLocationKey) REFERENCES preferred_locations (locationKey), cannot reference locationKey as that is unable to be a PK, therefore this cannot be a foreign key
